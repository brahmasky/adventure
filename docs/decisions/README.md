...
| [0010](0010-natural-language-intent-layer.md) | Interaction model — natural-language intent layer (Houge as Claude Code over Telegram) | accepted; enum-as-dispatch refined by [0013](0013-llm-inner-composition.md); amended 2026-07-27 by [0027](0027-idea-panel-claude-chair.md) (contained panel chair seat) |
| [0011](0011-self-evolution-architecture.md) | Self-evolution architecture — code, skills, lessons (three layers, dual eval gates, Codex muscle) | accepted; refined by [0012](0012-self-evolution-spine-closed-loop.md); amended 2026-07-27 by [0027](0027-idea-panel-claude-chair.md) (contained panel chair seat) |
...
| [0014](0014-dual-llm-privilege-separation.md) | Dual-LLM privilege separation — the reader that touches untrusted bytes cannot act (quarantined Q-LLM reader + privileged P-LLM planner; restores the [0006](0006-web-read-capability.md) wall inside the [0013](0013-llm-inner-composition.md) loop) | accepted (design; build after secrets firewall); amended 2026-09-06 (CLI-only reader `agy-cli,pi`; tool use permitted-and-contained on the agentic reader leg) — see [2026-09-04-cli-only-llm-and-audit-chokepoint-design.md](../superpowers/specs/2026-09-04-cli-only-llm-and-audit-chokepoint-design.md) |
...
| [0018](0018-kill-switch.md) | Durable kill switch — park-alive tombstone + disarm posture | accepted; amended 2026-09-06 (park marker `houge.parked`; revival command shell-portable) — see [2026-09-04-cli-only-llm-and-audit-chokepoint-design.md](../superpowers/specs/2026-09-04-cli-only-llm-and-audit-chokepoint-design.md) |
| [0019](0019-metered-ceiling.md) | Metered-API $ ceiling — ledger-derived spend, latch-driven enforcement | accepted; amended 2026-09-06 (D3: OpenAI-compat output = max(completion, total − prompt); metered legs off every default chain) — see [2026-09-04-cli-only-llm-and-audit-chokepoint-design.md](../superpowers/specs/2026-09-04-cli-only-llm-and-audit-chokepoint-design.md); amended 2026-09-07 (slice 2: pricing in the audit sink; readers union `llm_attempt`; run-less reads now metered) |
...
| [0024](0024-introspection-invariant-sweep.md) | Introspection — the deterministic invariant sweep as Houge's first self-sensing organ (the **sense** stage ADR 0012 left open) | accepted; amended 2026-09-06 (`heartbeat_gap` park-aware) — see [2026-09-04-cli-only-llm-and-audit-chokepoint-design.md](../superpowers/specs/2026-09-04-cli-only-llm-and-audit-chokepoint-design.md); amended 2026-09-07 (slice 2: seventh invariant `llm_leg_failing`) |
...
| [0026](0026-idea-radar-read-surface.md) | Idea Radar — a code-owned read surface for builder-idea sensing (daily flag-gated tick over a code-owned source registry; deterministic slimmers as the trust boundary; one extract LLM call; bounded `ideas` store; no new provider, no write path) | accepted; extended by [0027](0027-idea-panel-claude-chair.md) (panel write path + chair) |
| [0027](0027-idea-panel-claude-chair.md) | Idea panel — weekly judge panel with a contained Claude chair (3 judges + quorum 2 + deterministic fallback; tool-less single-turn chair spawn under an isolated config dir; broker seven→eight; `memory/briefs/` projection write path with the semantic-injection residual accepted; amends [0010](0010-natural-language-intent-layer.md) + [0011](0011-self-evolution-architecture.md) — "never the engine" narrows to "never the conversational/chain engine, never runtime self-write") | accepted; amended 2026-09-06 (judges 1–2 moved from `kimi-api`/`gemini-api` to the flat-rate `pi`/`agy` CLIs) — see [2026-09-04-cli-only-llm-and-audit-chokepoint-design.md](../superpowers/specs/2026-09-04-cli-only-llm-and-audit-chokepoint-design.md) |
